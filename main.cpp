...
{
	QFile file("/home/nkp/Agva_QtProjects/25/ecg3.txt");
...
int main(int argc, char *argv[])
{
	...
	//b1->show();
	//button b2(ui->centralwidget);
	//ui->centralwidget
	//b1.showMaximized();


	//following 4 decommented
			MainWindow w;
...
//		slice1->setPen(QPen(Qt::red, 2));//slice1->setPen(QPen(Qt::darkGreen, 2));
